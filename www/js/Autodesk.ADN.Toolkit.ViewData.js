...
Autodesk.ADN.Toolkit.ViewData.AdnViewDataClient = function (
    ...
    this.register = function (fileId) {
        ...
        xhr.open('POST',
            _baseUrl + '/modelderivative/v2/designdata/job',
            false);
        ...
        if ((fileId.indexOf(".zip")>=0)||(fileId.indexOf(".f3z")>=0) ){
            body.input.compressedUrn = true;
            body.input.rootFilename = fileId.slice(fileId.indexOf("/")+2,-4); //"AssemblyTest.iam" // 0ace8dc1-f8cf-426f-b73d-3f520995351a.f3d;
        }
